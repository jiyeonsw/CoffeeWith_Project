...
<table class="table table-bordered">
	<tr>
		<td>
			...
			<img src="${root}/upload/${userphoto}" onerror="this.src='../images/noimage.png'" width="60" height="60"
		...
		<td>
			...
			<c:if test="${sessionScope.loginok!=null && sessionScope.loginid == dto.id}">
				...
				<button type="button" class="btn btn-outline-danger"
						onclick="location.href='delete?num=${dto.num}&currentPage=${currentPage}'">삭제
				</button>
			</c:if>
		</td>
	</tr>
