...
<head>
    ...
    <style>
        .findpw{padding-left: 300px; padding-top: 30px;}
...
<div class="findpw">
    ...
    <ul class="findpw_form">
        <li>
            <div class="findpw_nm"><label>이름</label></div>
        ...
        <br>
        <li>
            <div class="findpw_ml"><label>이메일 주소</label></div>
            <span class="box_input">
        ...
        <li>
            <div class="findpw_ph"><label>휴대폰 번호</label></div>
            <span class="box_input">
